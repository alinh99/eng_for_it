...
class Quiz45Minutes extends StatefulWidget {
  const Quiz45Minutes({Key key}) : super(key: key);
  static String id = 'quiz_45_minutes';

  @override
  State<Quiz45Minutes> createState() => _Quiz45MinutesState();
}

class _Quiz45MinutesState extends State<Quiz45Minutes>
      ...
      if (status == AnimationStatus.completed) {
        showDialog(
          ...
          builder: (ctx) => ResultBox(
            backgroundColor: const Color(0xffA272FF),
            result: score,
            questionLength: 15,
            press: startOver,
          ),
                  ...
                  child: Column(
                    children: [
                      QuestionWidget(
                        ...
                        questionLength: (extractedData.length / 1.6).ceil(),
                        title: '45 Minutes',
                        time: Countdown(
                          animation: StepTween(
