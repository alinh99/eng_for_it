...
class Quiz60Minutes extends StatefulWidget {
  const Quiz60Minutes({Key key}) : super(key: key);
  static String id = 'quiz_60_minutes';

  @override
  State<Quiz60Minutes> createState() => _Quiz60MinutesState();
}

class _Quiz60MinutesState extends State<Quiz60Minutes>
