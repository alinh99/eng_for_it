...
class Quiz15Minutes extends StatefulWidget {
  const Quiz15Minutes({Key key}) : super(key: key);
  static String id = 'quiz_15_minutes';

  @override
  State<Quiz15Minutes> createState() => _Quiz15MinutesState();
}

class _Quiz15MinutesState extends State<Quiz15Minutes>
      ...
      if (status == AnimationStatus.completed) {
        showDialog(
          ...
          builder: (ctx) => ResultBox(
            backgroundColor: const Color(0xFF4DAFEE),
            result: score,
            questionLength: 15,
            press: startOver,
          ),
          ...
          if (snapshot.hasData) {
            ...
            return Scaffold(
              ...
              bottomNavigationBar: GestureDetector(
                onTap: () {
                  nextQuestion((extractedData.length / 4.7).round());
                },
                child: const NextButton(
                  color: Color(0xFF4DAFEE),
                ),
              ),
              body: SafeArea(
                  ...
                  child: Column(
                    children: [
                      QuestionWidget(
                        ...
                        questionLength: (extractedData.length / 4.7).round(),
                        title: '15 Minutes',
                        time: Countdown(
                          animation: StepTween(
